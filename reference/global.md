...
`global` is created empty and filled when cs9example is loaded. It holds
two things every task needs: `global$border`, the Norwegian border year
the package is configured for, and `global$ss`, a
